...
# Here we define the environment. This won't generally change much between tasks,
# but it is useful to have a separate class for the task and the environment.
